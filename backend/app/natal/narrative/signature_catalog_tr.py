...
SIGNATURES_V0_TR: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "gift": "En iyi hâlinde vizyonu sisteme çevirirsin; insanlara sadece ilham değil rota da verirsin.",
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "spark": "Söz senin kasın; yanlış anlaşılma ihtimali doğunca içeride ‘tonu düzelt’ refleksi devreye girer.",
            "gift": "En iyi hâlinde az kelimeyle güven kurarsın; hem kendine hem karşı tarafa alan açarsın.",
            "watch": "Zorlandığında fazla açıklama ya da gereğinden sert sınır riski var; niyet cümlesiyle başlamak dengeyi kurar.",
        },
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "watch": "Zorlandığında fazla düşünmek karar geciktirebilir; tek sprint yaklaşımı iyi gelir.",
        },
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "gift": "İyi çalıştığında metin, ürün, plan ve sistem kurmada ustalık verir.",
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "teaser": "Heves değil yöntem; rota netleşince hızlanırsın.",
            ...
            "watch": "Zorlandığında aynı anda 3 rota açma riski var; tek sprint seçmek seni uçurur.",
        },
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "watch": "Zorlandığında erteleme ya da yeniden başlatma döngüsü artar; küçük plan + ilk adım en iyi ilacın.",
        },
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "watch": "Zorlandığında sis artabilir; tek çıktı belirlemek ilhamı somutlaştırır.",
        },
    ...
    },
    {
        ...
        "chips": ["Sistem + Yenilik", "Upgrade", "Kalibrasyon"],
        ...
        "copy_tr": {
            ...
            "spark": "Bir şeyi yıkıp savurmaktan çok, iyileştirip upgrade etmeyi seçersin.",
            "gift": "İyi çalıştığında ürün, süreç, takım ve hayat düzeninde kalıcı dönüşüm sağlar.",
            "watch": "Zorlandığında fazla mükemmellik yüklenebilir; küçük iterasyon en iyi yol.",
        },
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "watch": "Zorlandığında ya tamamen açılmak ya tamamen kapanmak görülebilir; küçük netlik cümlesi en iyi köprü.",
        },
    ...
    },
    {
        ...
        "chips": ["Gizli Hassasiyet", "Pişirip Çık", "Derin Sevgi"],
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "watch": "Zorlandığında görünürlük ertelenebilir; küçük ama düzenli vitrin en iyi strateji.",
        },
    ...
    },
    {
        ...
        "spark": True,
        "block_affinity": ["career_visibility"],
        "chips": ["Düzenli Vitrin", "Hassas Görünürlük", "İz Bırak"],
        "rules": [
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "watch": "Zorlandığında saklanma artabilir; küçük vitrin adımları şifayı başlatır.",
        },
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "watch": "Zorlandığında içe kapanma artabilir; küçük sosyal temas dengeyi kurar.",
        },
    ...
    },
    {
        ...
        "copy_tr": {
            ...
            "gift": "İyi çalıştığında yaratım ve görünür çıktı fırsat doğurur.",
            "watch": "Zorlandığında bekleme uzar; tek adım şansı hareketlendirir.",
        },
